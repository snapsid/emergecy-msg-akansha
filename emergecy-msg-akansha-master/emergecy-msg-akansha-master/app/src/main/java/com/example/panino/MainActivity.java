    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                smsManager.sendTextMessage(a, null, "There's an Emergency please reach out to me asap\n"+mapsurl+lat+","+lon, null, null);

                SmsManager smsManager1 = SmsManager.getDefault();
                smsManager1.sendTextMessage(b, null, "There's an Emergency please reach out to me asap\n"+mapsurl+lat+","+lon, null, null);

                SmsManager smsManager2 = SmsManager.getDefault();
                smsManager2.sendTextMessage(c, null, "There's an Emergency please reach out to me asap\n"+mapsurl+lat+","+lon, null, null);
            }
        });
